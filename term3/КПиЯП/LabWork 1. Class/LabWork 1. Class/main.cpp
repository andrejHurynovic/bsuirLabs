...
int main(int argc, const char * argv[]) {
    ...
    do{
        ...
        switch (temp) {                         //switch  для выбора операции
            case 1:
                firstMatrix.summation(secondMatrix);            //проведение операции суммирования
                break;
            case 2:
                firstMatrix.multiplication(secondMatrix);       //проведение операции умножения
                break;
        }
        
        cout << "Result matrix:\n";
        firstMatrix.showMatrix();       //вывод результатов операции
