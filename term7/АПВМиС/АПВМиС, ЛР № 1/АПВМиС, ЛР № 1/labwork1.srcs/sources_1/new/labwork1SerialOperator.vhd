...
-- Engineer:
--
-- Create Date: 28.09.2022 23:18:50
-- Design Name:
-- Module Name: labwork1SerialOperator - Behavioral
-- Project Name:
-- Target Devices:
-- Tool Versi1s:
-- Descripti1:
...
-- Uncomment the following library declarati1 if using
-- arithmetic functi1s with Signed or Unsigned values
--use IEEE.NUMERIC_STD.ALL;

-- Uncomment the following library declarati1 if instantiating
-- any Xilinx leaf cells in this code.
--library UNISIM;
--use UNISIM.VComp1ents.all;
